...
class MTREE_OT_InstallUpdatePopup(bpy.types.Operator):
	"""Check and install update if available"""
	bl_label = "Update {x} addon".format(x=updater.addon)
	bl_idname = "mtree.install_update_popup"
...
class MTREE_OT_UpdaterCheckNow(bpy.types.Operator):
	bl_label = "Check now for "+updater.addon+" update"
	bl_idname = "mtree.updater_check_now"
...
class MTREE_OT_UpdaterUpdateNow(bpy.types.Operator):
	bl_label = "Update "+updater.addon+" addon now"
	bl_idname = "mtree.updater_update_now"
...
class MTREE_OT_UpdaterUpdateTarget(bpy.types.Operator):
	bl_label = updater.addon+" version target"
	bl_idname = "mtree.updater_update_target"
...
class MTREE_OT_UpdaterInstallManually(bpy.types.Operator):
	"""As a fallback, direct the user to download the addon manually"""
	bl_label = "Install update manually"
	bl_idname = "mtree.updater_install_manually"
...
class MTREE_OT_UpdaterUpdateSuccessful(bpy.types.Operator):
	"""Addon in place, popup telling user it completed or what went wrong"""
	bl_label = "Installation Report"
	bl_idname = "mtree.updater_update_successful"
...
class MTREE_OT_UpdaterRestoreBackup(bpy.types.Operator):
	"""Restore addon from backup"""
	bl_label = "Restore backup"
	bl_idname = "mtree.updater_restore_backup"
...
class MTREE_OT_UpdaterIgnore(bpy.types.Operator):
	"""Prevent future update notice popups"""
	bl_label = "Ignore update"
	bl_idname = "mtree.updater_ignore"
...
class MTREE_OT_EndBckndCheck(bpy.types.Operator):
	"""Stop checking for update in the background"""
	bl_label = "End background check"
	bl_idname = "mtree.end_background_check"
...
classes = (
	MTREE_OT_InstallUpdatePopup,
	MTREE_OT_UpdaterUpdateNow,
	MTREE_OT_UpdaterUpdateTarget,
	MTREE_OT_UpdaterInstallManually,
	MTREE_OT_UpdaterUpdateSuccessful,
	MTREE_OT_UpdaterRestoreBackup,
	MTREE_OT_UpdaterIgnore,
	MTREE_OT_EndBckndCheck
)
